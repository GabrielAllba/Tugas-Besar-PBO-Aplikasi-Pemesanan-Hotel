...
public class LoginAdminHotel extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Admin Hotel Login");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                    ...
                    .addComponent(btnLogin2, javax.swing.GroupLayout.PREFERRED_SIZE, 73, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGap(142, 142, 142)))
        );
    ...
    private void registerbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registerbtnActionPerformed
         this.dispose();
         RegisterAdminHotel r = new RegisterAdminHotel();
         r.setVisible(true);
    ...
    private void btnLogin2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLogin2ActionPerformed
         try{
            ...
            String sql = "SELECT * FROM hoteladmin WHERE username='" + txUsername.getText()
...
//223672404
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoginAdminHotel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LoginAdminHotel().setVisible(true);
            }
        });
    }
